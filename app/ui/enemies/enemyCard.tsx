...
import EnemyContent from "@/app/ui/enemies/enemyContent";
...
export default function EnemyCard ({name, position}: EnemyCardProps) {
    ...
    return (
        <Card sx={{
            ...
            <EnemyContent open={drawerOpen} toggleDrawer={toggleDrawer} name={name} position={position}></EnemyContent>
        </Card>
    );
}